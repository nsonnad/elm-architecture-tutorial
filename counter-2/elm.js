...
Elm.CounterPair.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Bsdf = function (a) {    return {ctor: "Bsdf",_0: a};};
   var Asdf = function (a) {    return {ctor: "Asdf",_0: a};};
   var Reset = {ctor: "Reset"};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Counter.view,A2($Signal.forwardTo,address,Asdf),model.topCounter)
              ,A2($Counter.view,A2($Signal.forwardTo,address,Bsdf),model.bottomCounter)
   ...
   var update = F2(function (action,model) {
      ...
      {case "Reset": return A2(init,0,0);
         case "Asdf": return _U.update(model,{topCounter: A2($Counter.update,_p0._0,model.topCounter)});
   ...
   return _elm.CounterPair.values = {_op: _op,Model: Model,init: init,Reset: Reset,Asdf: Asdf,Bsdf: Bsdf,update: update,view: view};
};
Elm.Main = Elm.Main || {};
